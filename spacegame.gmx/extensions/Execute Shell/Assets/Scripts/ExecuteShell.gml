...
{
    if (argument_count <= 2)
        var ExecuteShell_result = external_call(external_define("ExecuteShell.dll", "ExecuteShell", dll_cdecl, ty_string, 2, ty_string, ty_real), argument[0], argument[1]);
    else
        var ExecuteShell_result = external_call(external_define("ExecuteShell.dll", "ExecuteShellEx", dll_cdecl, ty_string, 3, ty_string, ty_real, ty_real), argument[0], argument[1], argument[2]);

...
if (instance_exists(O_Ship))
{
    ...
    {
        draw_rectangle(_x, _y - 154, _x + 280/100*controller.ship_health, _y - 124, false);
    }
    // Fuel
    draw_set_color(c_fuel);
    if (controller.fuel > 0)
    {
        draw_rectangle(_x, _y - 104, _x + 280/100*controller.fuel, _y - 70, false);
    }
    // Furnace
